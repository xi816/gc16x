...
ggrgb rgbv[] = {
  ...
  (ggrgb){.r = 0x80, .g = 0x00, .b = 0x00},
  (ggrgb){.r = 0x00, .g = 0x80, .b = 0x00},
  (ggrgb){.r = 0x80, .g = 0x80, .b = 0x00},
  (ggrgb){.r = 0x00, .g = 0x00, .b = 0x80},
  (ggrgb){.r = 0x80, .g = 0x00, .b = 0x80},
  (ggrgb){.r = 0x00, .g = 0x80, .b = 0x80},
  (ggrgb){.r = 0x80, .g = 0x80, .b = 0x80},

  (ggrgb){.r = 0x60, .g = 0x60, .b = 0x60},
  (ggrgb){.r = 0xFF, .g = 0x00, .b = 0x00},
  (ggrgb){.r = 0x00, .g = 0xFF, .b = 0x00},
  (ggrgb){.r = 0xFF, .g = 0xFF, .b = 0x00},
  (ggrgb){.r = 0x00, .g = 0x00, .b = 0xFF},
  (ggrgb){.r = 0xFF, .g = 0x00, .b = 0xFF},
  (ggrgb){.r = 0x00, .g = 0xFF, .b = 0xFF},
